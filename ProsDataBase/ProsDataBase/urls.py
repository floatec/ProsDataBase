...
urlpatterns = patterns(
    ...
    (r'^modifyDataset/(?P<table_id>\w+)/(?P<datasetID>\w+)/$', TemplateView.as_view(template_name="modifyDataset.html")),
    ...
    (r'^api/table/(?P<tableName>\w+)/(?P<datasetID>\d+.\d{4}_\d+_\w)/$', "database.views.api.dataset"),
